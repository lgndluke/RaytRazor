...
class qbMatrix2
{
    ...
    // qbMatrix2 * qbVector.
    template <class U> friend Vector<U> operator* (const qbMatrix2<U>& lhs, const Vector<U>& rhs);
...
// matrix * vector
template <class T>
Vector<T> operator* (const qbMatrix2<T>& lhs, const Vector<T>& rhs)
{
